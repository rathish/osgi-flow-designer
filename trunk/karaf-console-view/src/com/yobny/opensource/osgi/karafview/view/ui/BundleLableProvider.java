...
public class BundleLableProvider extends LabelProvider implements
	...
	public Image getColumnImage(Object arg0, int arg1) {
		if (arg0 instanceof ListCmdPojo) {
	...
	public String getColumnText(Object arg0, int arg1) {
		...
		} else if (arg0 instanceof BundleListCmdPojo) {
			BundleListCmdPojo cmdPojo = (BundleListCmdPojo) arg0;
			
			switch (arg1) {
			case 0:
				return "";
			case 1:
				return cmdPojo.getPresentationName();
			case 2:
				return cmdPojo.getVersion();
			default:
				throw new RuntimeException("Unexpected colum number:" + arg1);
			}
		} else {
